...
# اذا حطيت فاينل قبل كلمة كلاس يعني ممنوع العديل عليه بقا اي ممنوع عمل ايكستند منو  
/* final */ class Apple_Device{
    // Properties
            public $ram;
            public $inch;
            public $space; 
            ...
            final public function seyHello($n){
                $this->name = $n;
                echo "Welcom to ". $n;
            }
...
class Sony extends Apple_Device{
    ...
    // public function seyHello($n){  لانو كتبت فاينل للدالة الاساسية بالكلاس الاساسي الي ورثت منو اي لا يمكن التعديل على الدالة في اي مكان غير الكلاس الاساسي
    //     $this->name = $n;
